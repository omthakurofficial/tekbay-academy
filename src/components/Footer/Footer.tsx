          ...
          <div className="footer-brand">
            ...
            <div className="footer-social">
              ...
              <div className="social-links">
                <a href="https://www.linkedin.com/company/tekbayacademy/" 
                   target="_blank" 
                ...
                <a href="https://www.facebook.com/profile.php?id=61582254125165" 
                   target="_blank" 
                   rel="noopener noreferrer"
                ...
                <a href="https://www.instagram.com/tekbay_academy" 
                   target="_blank" 
                   rel="noopener noreferrer"
