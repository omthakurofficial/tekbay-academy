    ...
    <div className="course-details">
      ...
      <section className="course-section bg-light">
        <div className="container">
          ...
          <div className="trainers-professional-grid single-trainer">
            <div className="trainer-professional-card">
              ...
              <div className="trainer-info">
                ...
                <p className="trainer-title">Senior AI/ML Engineer & Trainer</p>
                <p className="trainer-experience">Machine Learning Expert</p>
                <div className="trainer-credentials">
                  <span className="credential-badge">AWS ML Certified</span>
                  <span className="credential-badge">AI/ML Expert</span>
                </div>
                <a 
